function [fre,x,xpp,vett_str,nfig_end]=FRFd(handles,nfig,type);
...
[force,idir,vf,iexit]=assign_forces_data_distrib(idb,ngdl,nf,lingua_it,beams,Tbeams,nbeam,nbeamT);
if iexit;return;end;
